...
const CATEGORY_META = [
  { slug: "all-dresses", title: "All Dresses", subtitle: "Find Your Vibe in Effortless Dresses", tagline: "Where timeless design meets everyday elegance.", cta: "SHOP NOW", to: "/collections/dresses" },
  { slug: "maxi-midi", title: "Maxi & Midi Statements", subtitle: "Own Your Moment in Maxi & Midi Styles", tagline: "Flowing silhouettes that speak confidence.", cta: "SHOP NOW", to: "/collections/maxi-midi" },
  { slug: "evening-edit", title: "The Evening Edit", subtitle: "Turn Every Night Into a Statement", tagline: "Luxury evening wear designed to dazzle.", cta: "SHOP NOW", to: "/collections/evening-edit" },
  { slug: "all-trousers", title: "All Trousers", subtitle: "Power Dressing, Perfected", tagline: "Tailored trousers for style and substance.", cta: "SHOP NOW", to: "/collections/trousers" },
  { slug: "global-silhouettes", title: "Global Silhouettes", subtitle: "Inspired by the World, Made for You", tagline: "Western wear with a modern global twist.", cta: "SHOP NOW", to: "/collections/global-silhouettes" },
  { slug: "classic-bootcut", title: "The Classic Bootcut", subtitle: "Where Elegance Meets Comfort", tagline: "Bootcut trousers designed to flatter every step.", cta: "SHOP NOW", to: "/collections/bootcut" },
  { slug: "all-tops", title: "All Tops", subtitle: "Elevate Your Everyday", tagline: "Versatile tops for modern women on the move.", cta: "SHOP NOW", to: "/collections/tops" },
  { slug: "lyrical-blouse", title: "The Lyrical Blouse", subtitle: "Feminine · Fluid · Fearless", tagline: "Blouses that add poetry to your wardrobe.", cta: "SHOP NOW", to: "/collections/lyrical-blouse" },
  { slug: "thesis-on-shirts", title: "A Thesis on Shirts", subtitle: "Smart. Sharp. Sophisticated.", tagline: "Reimagining shirts for the empowered woman.", cta: "SHOP NOW", to: "/collections/shirts" },
];
